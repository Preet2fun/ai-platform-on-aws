...
SPECIALIST_ARN_MAP: Dict[str, str] = {
    "cloudwatch": settings.CLOUDWATCH_A2A_ARN,
    "security":   settings.SECURITY_A2A_ARN,
    "cost":       settings.COST_A2A_ARN,
    "advisor":    settings.ADVISOR_A2A_ARN,
    "jira":       settings.JIRA_A2A_ARN,
    "knowledge":  settings.KNOWLEDGE_A2A_ARN,
}
